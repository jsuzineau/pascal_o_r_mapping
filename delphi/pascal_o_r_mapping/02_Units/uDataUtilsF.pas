...
function RefreshQuery( CD: TClientDataset;
                       _Afficher_Erreur: Boolean= True): Boolean; overload;
...
function Table_exists( _sqlc: TSQLConnection; _NomTable: String): Boolean;
...
function Create_ParamList_from_Query( CD: TClientDataset): TBatpro_StringList;overload;
var
   D: TDataset;
   sl: TBatpro_StringList;
begin
...
procedure TraiteExceptionRequete( sqlc: TSQLConnection; SQL: String; E: Exception; var Resultat: Boolean;
...
procedure TraiteExceptionRequete( CD: TClientDataset; E: Exception; var Resultat: Boolean;
                                  _Afficher_Erreur: Boolean= True);overload;
var
   sdm: String;
   slParam: TBatpro_StringList;
...
function ClientDataset_QueryText( CD: TClientDataset): String;
var
   d: TDataset;
begin
     Result:= sys_Vide;
...
function ClientDataset_ConnectionText( CD: TClientDataset): String;
var
   d: TDataset;
begin
     Result:= sys_Vide;
       ...
       try
          ...
          try
             ...
             Result:= True;
                ...
                do
                  begin
                  TraiteExceptionRequete( SQLQ, E, Result, sqlq.SQLConnection,_Afficher_Erreur, _Contexte);
                  Close;
                  end;
                end;
       finally
     ...
     do
       try
          ...
          try
             ...
             then
                 begin
                 Dsource:= Dataset_from_ClientDataset( TClientDataSet(D));
...
begin
     ...
     do
       ...
       if (TypeSource <> TypeCible)
          ...
          and (not ((TypeSource = 'TIntegerField')and(TypeCible= 'TAutoIncField')))
...
begin
     ...
     // Pile d'appels:
     //    TLog_SQL.LogQ
     //    RefreshQuery( CD: TClientDataset)
