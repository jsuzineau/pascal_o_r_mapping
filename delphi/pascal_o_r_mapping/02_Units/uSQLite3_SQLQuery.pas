...
begin
     sqlcSQLite3:= TSQLConnection.Create(nil);
     Result:= sqlcSQLite3;
     //if Assigned( Result)
     //then
...
begin
     ...
     Default_Database:= GetCurrentDir+TPath.DirectorySeparatorChar+'SQLite3_database.db';
     ...
     sqlcSQLite3.Params.Values['DatabaseName']:= Database;
