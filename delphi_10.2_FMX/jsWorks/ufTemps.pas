...
uses
 ...
 Classes, SysUtils, FMX.Forms, FMX.Controls, FMX.Graphics, FMX.Dialogs, FMX.DateTimeCtrls,
 FMX.ExtCtrls, Buttons, dateutils,Clipbrd, FMX.StdCtrls, FMX.Edit, FMX.Memo;
...
begin
     ...
     cbEcrire_arrondi.IsChecked:= ublSession_Ecrire_arrondi;
     cbHeures_Supplementaires.IsChecked:= ublCalendrier_Heures_Supplementaires;
...
begin
     ...
     if not cbRestreindre_a_un_Tag.IsChecked then exit;
...
begin
     ublSession_Ecrire_arrondi:= cbEcrire_arrondi.IsChecked;
end;

procedure TfTemps.cbHeures_SupplementairesChange(Sender: TObject);
begin
     ublCalendrier_Heures_Supplementaires:= cbHeures_Supplementaires.isChecked;
end;
...
var
   ...
   Resultat: String;
begin
     od:= TodCalendrier.Create( cbDepassement.isChecked);
     try
