...
uses
    ...
    uContexteMembre,
    uJoinPoint,
  SysUtils, Classes, System.IOUtils, System.Types;
...
type
  TFileFoundEvent = procedure (_NomFichier: String) of object;
...
begin
     Files
     :=
       TDirectory.GetFiles( _sRepertoire,
                            _Mask,
                            ...
                            begin
                                 Result:= (faDirectory and SearchRec.Attr) = 0;
                            end
                            );
