...
type
 ...
 =
  ...
  private
    fgl_putfile_interne_CriticalSection: TCriticalSection;
  ...
  //version "synchronize" de fgl_putfile
  private
    lg_Traite_Fichier_Genere_interne_CriticalSection: TCriticalSection;
...
begin
     try
        ...
        try
           Result:= c.Get( _URL).ContentAsString;
        finally
               FreeAndNil( c);
               end;
     except
...
begin
     ...
     th:= nil;
     Modal:= True;
                  fgl_putfile_interne_CriticalSection:= TCriticalSection.Create;
     lg_Traite_Fichier_Genere_interne_CriticalSection:= TCriticalSection.Create;
...
begin
     ...
     FreeAndNil( lg_Traite_Fichier_Genere_interne_CriticalSection);
     FreeAndNil( fgl_putfile_interne_CriticalSection);
     Free_nil( slP   );
     Free_nil( slO   );
     inherited Destroy;
end;
...
begin
     ...
     fgl_putfile_interne_CriticalSection.Enter;
     try
        ...
        Synchronize( fgl_putfile_interne);
            ...
            fgl_putfile_interne_CriticalSection.Leave;
            end;
...
begin
     ...
     lg_Traite_Fichier_Genere_interne_CriticalSection.Enter;
     try
        ...
        Synchronize( lg_Traite_Fichier_Genere_interne);
            ...
            lg_Traite_Fichier_Genere_interne_CriticalSection.Leave;
            end;
