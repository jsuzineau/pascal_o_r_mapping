...
type
  ...
  =
   class
     function DOCSINGL: String;
     function DOCSINGL_id: String;
     function DOCSINGL_width: Integer;
     function DOCSINGL_height: Integer;

     function LOSANGE: String;
     function LOSANGE_id: String;
     function LOSANGE_width: Integer;
     function LOSANGE_height: Integer;

     function LOGIN: String;
     function LOGIN_id: String;
     function LOGIN_width: Integer;
     function LOGIN_height: Integer;

     function MEN_AT_WORK: String;
     function MEN_AT_WORK_id: String;
     function MEN_AT_WORK_width: Integer;
     function MEN_AT_WORK_height: Integer;

     function DOSSIER_KDE_PAR_POSTE: String;
     function DOSSIER_KDE_PAR_POSTE_id: String;
     function DOSSIER_KDE_PAR_POSTE_width: Integer;
     function DOSSIER_KDE_PAR_POSTE_height: Integer;
   end;

function SVG_Bitmaps: TSVG_Bitmaps;
...
var
   FSVG_Bitmaps: TSVG_Bitmaps= nil;

function SVG_Bitmaps: TSVG_Bitmaps;
begin
     if nil = FSVG_Bitmaps
     then
         FSVG_Bitmaps:= TSVG_Bitmaps.Create;
     Result:= FSVG_Bitmaps;
end;

function TSVG_Bitmaps.DOCSINGL_id: String;
begin
     Result:= 'svgDOCSINGL';
end;

function TSVG_Bitmaps.DOCSINGL_width: Integer;
begin
     Result:= 16;
end;

function TSVG_Bitmaps.DOCSINGL_height: Integer;
begin
     Result:= 12;
end;

function TSVG_Bitmaps.DOCSINGL: String;
begin
     Result
     :=
 '<svg                                                                                                                                '#13#10
...
function TSVG_Bitmaps.LOSANGE_id: String;
begin
     Result:= 'svgLOSANGE';
end;

function TSVG_Bitmaps.LOSANGE_width: Integer;
begin
     Result:= 16;
end;

function TSVG_Bitmaps.LOSANGE_height: Integer;
begin
     Result:= 16;
end;

function TSVG_Bitmaps.LOSANGE: String;
begin
     Result
     :=
 '<svg                                                                                                               '#13#10
...
function TSVG_Bitmaps.LOGIN_id: String;
begin
     Result:= 'svgLOGIN';
end;

function TSVG_Bitmaps.LOGIN_width: Integer;
begin
     Result:= 16;
end;

function TSVG_Bitmaps.LOGIN_height: Integer;
begin
     Result:= 16;
end;

function TSVG_Bitmaps.LOGIN: String;
begin
     Result
     :=
 '<svg                                                                   '#13#10
...
function TSVG_Bitmaps.MEN_AT_WORK_id: String;
begin
     Result:= 'svgMEN_AT_WORK';
end;

function TSVG_Bitmaps.MEN_AT_WORK_width: Integer;
begin
     Result:= 16;
end;

function TSVG_Bitmaps.MEN_AT_WORK_height: Integer;
begin
     Result:= 16;
end;

function TSVG_Bitmaps.MEN_AT_WORK: String;
begin
     Result
     :=
...
+'id="'+MEN_AT_WORK_id+'" viewBox="0 0 298.09 264.13"                                '#13#10
+'version="1.1">                                                                        '#13#10
...
function TSVG_Bitmaps.DOSSIER_KDE_PAR_POSTE_id: String;
begin
     Result:= 'svgDOSSIER_KDE_PAR_POSTE';
end;

function TSVG_Bitmaps.DOSSIER_KDE_PAR_POSTE_width: Integer;
begin
     Result:= 16;
end;

function TSVG_Bitmaps.DOSSIER_KDE_PAR_POSTE_height: Integer;
begin
     Result:= 16;
end;

function TSVG_Bitmaps.DOSSIER_KDE_PAR_POSTE: String;
begin
     Result
     :=
...
+'   width="128"                                                                '#13#10
+'   height="128"                                                               '#13#10
+'   id="'+DOSSIER_KDE_PAR_POSTE_id+'">                                      '#13#10
+'  <defs                                                                       '#13#10
+'     id="defs6" />                                                            '#13#10
+'  <g                                                                          '#13#10
...
begin
     uOD_JCL.Set_Property( _e, _NodeName, _Value);
end;
...
begin
     uOD_JCL.Delete_Property( _e, _NodeName);
end;
...
function TSVGDocument.Cherche_Item( _eRoot: TDOMNode; _NodeName: String;
                                     ...
                                     _Properties_Values: array of String): TDOMNode;
begin
     Result:= uOD_JCL.Cherche_Item( _eRoot, _NodeName, _Properties_Names, _Properties_Values);
end;
...
function TSVGDocument.Cherche_Item_Recursif( _eRoot: TDOMNode; _NodeName: String;
                                              ...
                                              _Properties_Values: array of String): TDOMNode;
begin
     uOD_JCL.Cherche_Item_Recursif( _eRoot, _NodeName,_Properties_Names, _Properties_Values);
end;
