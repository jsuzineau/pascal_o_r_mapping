unit uGenerateur_Delphi_Ancetre;
{                                                                               |
...
constructor TGenerateur_Delphi_Ancetre.Create;
begin

end;

destructor TGenerateur_Delphi_Ancetre.Destroy;
begin
     inherited Destroy;
end;

function TGenerateur_Delphi_Ancetre.dbx_from_Type( Typ: String): String;
begin
     Typ:= UpperCase( Typ);
...
function TGenerateur_Delphi_Ancetre.TailleNom_Quote( S: String): String;
begin
