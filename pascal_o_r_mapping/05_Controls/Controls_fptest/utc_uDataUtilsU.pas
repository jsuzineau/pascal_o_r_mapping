...
//recopie de utA_CHT pour compilation
const
     dbv_secteur_provisoire= 'ZZ';
     dbv_chantier_prefixe_Modele_planning= 'MP';
     dbf_A_CHT_champ_code_responsable   = 'ci3';
     dbf_A_CHT_champ_libelle_responsable= 'vci3';
     dbv_CI_null= '999999';
