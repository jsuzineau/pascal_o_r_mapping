...
uses
  uOD_SurTitre,
  uOD_Merge,
  SysUtils, Classes, DB, BufDataset,Forms,
  TestFrameWork;
...
type
 ...
 =
  ...
  protected
    ...
    OD_Merge: TOD_Merge;
    procedure Cree_dataset_interne( _cd: TBufDataSet; _cd_Name: String;
                                    LigneMax: Integer= 42);
...
procedure TtcOD_TestCase.Cree_dataset_interne( _cd: TBufDataSet; _cd_Name: String;
                                               LigneMax: Integer= 42);
var
   Numero,
   Code,
