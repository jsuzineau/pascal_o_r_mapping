...
uses
    ...
    uReels,
    uContrainte,
  SysUtils, Classes, Controls, ComCtrls, DB, StdCtrls, ExtCtrls, Graphics,EditBtn;
...
{ TBatpro_Contrainte }
const
     TBatpro_Contrainte_Largeur_operateur= 100;
...
begin
     ...
     cbOperateur.Items.Add( 'est avant');
     cbOperateur.Items.Add( 'est aprés');
...
begin
     dtp.Date:= FContrainte.Critere_Date;
end;

procedure TBatpro_Contrainte.To_Date;
begin
     FContrainte.Critere_Date:= dtp.Date;
end;
