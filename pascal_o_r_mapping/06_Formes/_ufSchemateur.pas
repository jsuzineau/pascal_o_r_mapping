...
(*     NomTable:= Parametres;
     ...
     then
         ShowMessage( 'La table '+NomTable+' a été créée.')
     else
         ShowMessage( 'Des erreurs ont été rencontrées lors de la création de la table '+NomTable);*)
end;
...
(*     NomTable:= StrToK( ' ', Parametres);
     ...
     if dmDatabase.ExecQuery( slLignes.Text)
     then
         ShowMessage( 'L''index '+NomIndex+' sur la table '+NomTable+' a été créé.')
     else
         ShowMessage( 'Des erreurs ont été rencontrées lors de la création de l''index '
...
(*     NomTable:= StrToK( ' ', Parametres);
     ...
     if dmDatabase.ExecQuery( slLignes.Text)
     then
         ShowMessage( 'Le champ '+NomChamp+' sur la table '+NomTable+' a été créé.')
     else
         ShowMessage( 'Des erreurs ont été rencontrées lors de la création du champ '+NomChamp+' sur la table '+NomTable+'.');*)
end;
