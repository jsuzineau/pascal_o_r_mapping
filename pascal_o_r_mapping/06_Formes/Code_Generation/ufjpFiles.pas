...
type
 ...
 public
  ...
  //Recherche de 01_key
  private
    procedure Ouvre_FileFound( _FileIterator: TFileIterator);
...
procedure TfjpFiles.Ouvre_FileFound( _FileIterator: TFileIterator);
begin
     if _FileIterator.IsDirectory then exit;

     Cree_fjpFile( ExcludeTrailingPathDelimiter(ExtractFilePath( _FileIterator.FileName)));
end;
