...
type
 ...
 //Recherche de 01_key
 private
   procedure Cherche_01_key_FileFound( _FileIterator: TFileIterator);
...
procedure TfjpFile.Cherche_01_key_FileFound( _FileIterator: TFileIterator);
begin
     if _FileIterator.IsDirectory then exit;

     if Assigned(jpf) then exit;

     Cree_jpf( _FileIterator.FileName);
end;
