...
const
     TblOD_Affectation_NomChamp_Libelle_Nouveau='<Nouveau>';
...
begin
     ...
     _Keys  .Add( '');
     _Labels.Add( '<Aucun>');
     _Keys  .Add( TblOD_Affectation_NomChamp_Libelle_Nouveau);
     _Labels.Add( TblOD_Affectation_NomChamp_Libelle_Nouveau);
...
begin
     if not(TblOD_Affectation_NomChamp_Libelle_Nouveau=NomChamp_Libelle)                    then exit;
