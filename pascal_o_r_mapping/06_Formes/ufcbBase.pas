...
type
 ...
 =
  ...
  public
    ...
    Resultat, Valeur: TLongintField;
    function DerouleListe( Editeur: TObject; ds: TDataSource;
                           unNouveau: TExecuteFunction;
                           unResultat, uneValeur:TLongintField)
                           : Boolean; virtual;
    procedure Valide( ValeurValide: TLongintField); virtual;
  end;
...
(*
procedure Affecte( Resultat, Valeur: TLongintField);
var
   C: TComponent;
   D: TDataset;
begin
...
procedure TfcbBase.Valide( ValeurValide: TLongintField);
begin
