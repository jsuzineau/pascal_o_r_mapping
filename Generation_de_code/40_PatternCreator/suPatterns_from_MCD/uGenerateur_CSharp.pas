...
type
 ...
 =
  ...
  public
    ...
    procedure CreateFiles_CSharp;
  end;

var
   Generateur_CSharp: TGenerateur_CSharp= nil;

implementation

{ TGenerateur_CSharp }

procedure TGenerateur_CSharp.CreateFiles_CSharp;
const
     sys_Vide                 = '';
...
var
   ...
   var
      sRepRacine: String;
   begin
        sRepRacine:= sRepSource+'Tml'+s_NomTable;
...
begin
     ...
     INI
     :=
//       TIniFile.Create( ChangeFileExt(NomFichierProjet,'_StarUML_C#.ini'));
     ...
     try
        ...
        try
           ...
           //csMenuHandler:= TcsMenuHandler.Create( sRepSource, sRepCible);
...
procedure TGenerateur_CSharp.Initialise(_a: array of TJoinPoint);
var
   I: Integer;
begin
...
initialization
              Generateur_CSharp:= TGenerateur_CSharp.Create;
              Generateur_CSharp.Initialise(
                                           [
