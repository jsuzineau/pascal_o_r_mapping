...
type
 ...
 =
  ...
  public
    constructor Create( _cc: TContexteClasse; _sNomChamp, _sTypChamp, _sLibelle: String);
  end;
...
constructor TContexteMembre.Create( _cc: TContexteClasse; _sNomChamp, _sTypChamp, _sLibelle: String);
var
