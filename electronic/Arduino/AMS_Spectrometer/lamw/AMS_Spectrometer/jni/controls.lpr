...
library controls;  //[by LAMW: Lazarus Android Module Wizard: 27/11/2019 17:14:54]
 
{$mode delphi}
 
uses
 Classes, SysUtils, And_jni, And_jni_Bridge, AndroidWidget, Laz_And_Controls,
 Laz_And_Controls_Events, ufAMS_Spectrometer;
 
{%region /fold 'LAMW generated code'}

{ Class:     org_lamw_ams_spectrometer_Controls
 Method:    pAppOnCreate
...
begin
 ...
 begin
   curEnv:= PJNIEnv(PEnv);
   RegisterNativeMethods(curEnv, 'org/lamw/ams_spectrometer/Controls');
 end;
...
exports
 ...
 pAppOnCreate name 'Java_org_lamw_ams_spectrometer_Controls_pAppOnCreate',
 pAppOnScreenStyle name 'Java_org_lamw_ams_spectrometer_Controls_'
  +'pAppOnScreenStyle',
 pAppOnNewIntent name 
  'Java_org_lamw_ams_spectrometer_Controls_pAppOnNewIntent',
 pAppOnDestroy name 'Java_org_lamw_ams_spectrometer_Controls_pAppOnDestroy',
 pAppOnPause name 'Java_org_lamw_ams_spectrometer_Controls_pAppOnPause',
 pAppOnRestart name 'Java_org_lamw_ams_spectrometer_Controls_pAppOnRestart',
 pAppOnResume name 'Java_org_lamw_ams_spectrometer_Controls_pAppOnResume',
 pAppOnStart name 'Java_org_lamw_ams_spectrometer_Controls_pAppOnStart',
 pAppOnStop name 'Java_org_lamw_ams_spectrometer_Controls_pAppOnStop',
 pAppOnBackPressed name 'Java_org_lamw_ams_spectrometer_Controls_'
  +'pAppOnBackPressed',
 pAppOnRotate name 'Java_org_lamw_ams_spectrometer_Controls_pAppOnRotate',
 pAppOnConfigurationChanged name 'Java_org_lamw_ams_spectrometer_Controls_'
  +'pAppOnConfigurationChanged',
 pAppOnActivityResult name 'Java_org_lamw_ams_spectrometer_Controls_'
  +'pAppOnActivityResult',
 pAppOnCreateOptionsMenu name 'Java_org_lamw_ams_spectrometer_Controls_'
  +'pAppOnCreateOptionsMenu',
 pAppOnClickOptionMenuItem name 'Java_org_lamw_ams_spectrometer_Controls_'
  +'pAppOnClickOptionMenuItem',
 pAppOnPrepareOptionsMenu name 'Java_org_lamw_ams_spectrometer_Controls_'
  +'pAppOnPrepareOptionsMenu',
 pAppOnPrepareOptionsMenuItem name 'Java_org_lamw_ams_spectrometer_Controls_'
  +'pAppOnPrepareOptionsMenuItem',
 pAppOnCreateContextMenu name 'Java_org_lamw_ams_spectrometer_Controls_'
  +'pAppOnCreateContextMenu',
 pAppOnClickContextMenuItem name 'Java_org_lamw_ams_spectrometer_Controls_'
  +'pAppOnClickContextMenuItem',
 pOnDraw name 'Java_org_lamw_ams_spectrometer_Controls_pOnDraw',
 pOnTouch name 'Java_org_lamw_ams_spectrometer_Controls_pOnTouch',
 pOnClickGeneric name 
  'Java_org_lamw_ams_spectrometer_Controls_pOnClickGeneric',
 pAppOnSpecialKeyDown name 'Java_org_lamw_ams_spectrometer_Controls_'
  +'pAppOnSpecialKeyDown',
 pOnDown name 'Java_org_lamw_ams_spectrometer_Controls_pOnDown',
 pOnClick name 'Java_org_lamw_ams_spectrometer_Controls_pOnClick',
 pOnLongClick name 'Java_org_lamw_ams_spectrometer_Controls_pOnLongClick',
 pOnDoubleClick name 'Java_org_lamw_ams_spectrometer_Controls_pOnDoubleClick',
 pOnChange name 'Java_org_lamw_ams_spectrometer_Controls_pOnChange',
 pOnChanged name 'Java_org_lamw_ams_spectrometer_Controls_pOnChanged',
 pOnEnter name 'Java_org_lamw_ams_spectrometer_Controls_pOnEnter',
 pOnClose name 'Java_org_lamw_ams_spectrometer_Controls_pOnClose',
 pAppOnViewClick name 
  'Java_org_lamw_ams_spectrometer_Controls_pAppOnViewClick',
 pAppOnListItemClick name 'Java_org_lamw_ams_spectrometer_Controls_'
  +'pAppOnListItemClick',
 pOnFlingGestureDetected name 'Java_org_lamw_ams_spectrometer_Controls_'
  +'pOnFlingGestureDetected',
 pOnPinchZoomGestureDetected name 'Java_org_lamw_ams_spectrometer_Controls_'
  +'pOnPinchZoomGestureDetected',
 pOnLostFocus name 'Java_org_lamw_ams_spectrometer_Controls_pOnLostFocus',
 pOnBeforeDispatchDraw name 'Java_org_lamw_ams_spectrometer_Controls_'
  +'pOnBeforeDispatchDraw',
 pOnAfterDispatchDraw name 'Java_org_lamw_ams_spectrometer_Controls_'
  +'pOnAfterDispatchDraw',
 pOnLayouting name 'Java_org_lamw_ams_spectrometer_Controls_pOnLayouting',
 pAppOnRequestPermissionResult name 'Java_org_lamw_ams_spectrometer_Controls_'
...
begin
 ...
 gjAppName:= 'org.lamw.ams_spectrometer';
 gjClassName:= 'org/lamw/ams_spectrometer/Controls';
 gApp.AppName:=gjAppName;
 gApp.ClassName:=gjClassName;
 gApp.Initialize;
 gApp.CreateForm(TfAMS_Spectrometer, fAMS_Spectrometer);
end.
