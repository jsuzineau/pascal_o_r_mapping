...
rtl.module("wasitypes",["System","JS"],function () {
  ...
  this.__WASI_RIGHTS_FD_READ = 2;
  this.__WASI_RIGHTS_FD_WRITE = 64;
  ...
  this.__WASI_FILETYPE_SOCKET_DGRAM = 5;
  this.__WASI_FILETYPE_SOCKET_STREAM = 6;
  this.__WASI_FILETYPE_SYMBOLIC_LINK = 7;
  this.__WASI_OFLAGS_CREAT = 1;
  this.__WASI_OFLAGS_DIRECTORY = 2;
  this.__WASI_OFLAGS_EXCL = 4;
  this.__WASI_OFLAGS_TRUNC = 8;
...
rtl.module("wasienv",["System","SysUtils","Classes","JS","webassembly","Types","wasitypes"],function () {
  ...
  rtl.createClass(this,"TPas2JSWASIEnvironment",pas.System.TObject,function () {
    ...
    this.DoConsoleWrite = function (IsStdErr, aBytes) {
      ...
      var Evt = null;
      try {
        S = this.UTF8TextDecoder.decode(aBytes);
      } catch ($e) {
        S = TryConvert();
      };
      if (IsStdErr) {
    ...
    this.args_sizes_get = function (argc, argvBufSize) {
      ...
      View = this.getModuleMemoryDataView();
      View.setUint32(argc,this.FArguments.GetCount(),this.FIsLittleEndian);
      Size = 0;
      if (this.FArguments.GetCount() > 0) Size = this.FArguments.GetTextStr().length + 1;
      View.setUint32(argvBufSize,Size,this.FIsLittleEndian);
      Result = 0;
      return Result;
    };
    ...
    this.environ_sizes_get = function (environCount, environBufSize) {
      ...
      View = this.getModuleMemoryDataView();
      View.setUint32(environCount,this.FEnvironment.GetCount(),this.FIsLittleEndian);
      Size = 0;
      if (this.FEnvironment.GetCount() > 0) Size = this.FEnvironment.GetTextStr().length + 1;
      View.setUint32(environBufSize,Size,this.FIsLittleEndian);
      Result = 0;
      return Result;
    };
    ...
    this.fd_pwrite = function (fd, iovs, iovsLen, offset, nwritten) {
      ...
      if ((fd === 1) || (fd === 2)) {
        ...
        if (Result === 0) view.setUint32(nwritten,written,this.FIsLittleEndian);
      };
      Result = 52;
      return Result;
    };
    ...
    this.fd_seek = function (fd, offset, whence, newOffsetPtr) {
      ...
      if (!(this.FWasiFS != null)) {
        ...
        if (Result === 0) Result = this.FWasiFS.Seek(fd,offset,lWhence,{get: function () {
            return NewPos;
          }, set: function (v) {
            NewPos = v;
          }});
        this.SetMemInfoInt64(newOffsetPtr,NewPos);
      } catch ($e) {
        if (pas.SysUtils.Exception.isPrototypeOf($e)) {
          var E = $e;
          Result = this.$class.ErrorToCode(E);
    ...
    this.fd_tell = function (fd, offsetPtr) {
      ...
      if (!(this.FWasiFS != null)) {
        ...
        Result = this.FWasiFS.Seek(fd,0,1,{get: function () {
            return NewPos;
          }, set: function (v) {
            NewPos = v;
          }});
    ...
    this.SetUTF8StringInMem = function (aLoc, aLen, AString) {
      ...
      if (Arr.byteLength > aLen) {
        ...
        Result = this.UTF8TextEncoder.encodeInto(AString,Arr).written;
      };
      return Result;
    };
    this.SetMemInfoInt32 = function (aLoc, aValue) {
      ...
      var View = null;
      View = this.getModuleMemoryDataView();
      View.setInt32(aLoc,aValue,this.FIsLittleEndian);
      Result = aLoc + 4;
      return Result;
    };
    this.SetMemInfoInt64 = function (aLoc, aValue) {
      ...
      var View = null;
      View = this.getModuleMemoryDataView();
      this.$class.setBigInt64(View,aLoc,aValue,this.FIsLittleEndian);
      Result = aLoc + 8;
      return Result;
    };
    ...
    this.SetMemInfoUInt32 = function (aLoc, aValue) {
      ...
      var View = null;
      View = this.getModuleMemoryDataView();
      View.setUint32(aLoc,aValue,this.FIsLittleEndian);
      Result = aLoc + 4;
      return Result;
    };
    this.SetMemInfoUInt64 = function (aLoc, aValue) {
      ...
      var View = null;
      View = this.getModuleMemoryDataView();
      this.$class.setBigUint64(View,aLoc,aValue,this.FIsLittleEndian);
      Result = aLoc + 8;
      return Result;
    };
...
rtl.module("wasihostapp",["System","Classes","SysUtils","BrowserApp","JS","webassembly","wasienv","Web","Types"],function () {
  "use strict";
  var $mod = this;
...
rtl.module("JOB_Browser",["System","SysUtils","Types","JS","Web","wasienv","JOB_Shared"],function () {
  "use strict";
  var $mod = this;
  var $impl = $mod.$impl;
  ...
  rtl.createClass(this,"TJSObjectBridge",pas.wasienv.TImportExtension,function () {
    ...
    this.Invoke_JSResult = function (ObjId, NameP, NameLen, Invoke, ArgsP, JSResult) {
      ...
      PropName = $impl.TypedArrayToString(aBytes);
      var $tmp = Invoke;
      if ($tmp === 0) {
        fn = Obj[PropName];
    ...
    this.GetInvokeArguments = function (View, ArgsP) {
      ...
      function ReadWasmNativeInt() {
        var Result = 0;
        Result = View.getInt32(p,$Self.FEnv.FIsLittleEndian);
        p += 4;
        return Result;
      };
      ...
      function ReadString() {
        ...
        p += Len * 2;
        Result = $impl.TypedArrayToString(aWords);
        return Result;
      };
      ...
      function ReadArgArrayOfDouble() {
        ...
        for (var $l = 0, $end = Cnt - 1; $l <= $end; $l++) {
          i = $l;
          Result[i] = View.getFloat64(El + (i * 8),$Self.FEnv.FIsLittleEndian);
        };
        return Result;
      };
      ...
      function ReadValue() {
        ...
        if ($tmp === 0) {
          ...
          Result = View.getFloat64(p,$Self.FEnv.FIsLittleEndian);
          p += 8;
        } else if ($tmp === 3) {
          Result = true}
         else if ($tmp === 4) {
          ...
          Result = String.fromCharCode(View.getUint16(p,$Self.FEnv.FIsLittleEndian));
          p += 2;
        } else if ($tmp === 6) {
          Result = ReadString()}
         else if ($tmp === 7) {
    ...
    this.CreateCallbackArgs = function (View, Args, TempObjIds) {
      ...
      for (var $l1 = 0, $end1 = Args.length - 1; $l1 <= $end1; $l1++) {
        ...
        if ($tmp1 === 6) {
          ...
          View.setUint8(p,2);
          p += 1;
          View.setFloat64(p,rtl.getNumber(Arg),this.FEnv.FIsLittleEndian);
          p += 8;
        } else if ($tmp1 === 9) {
          View.setUint8(p,7);
          p += 1;
          s = "" + Arg;
          View.setUint32(p,s.length,this.FEnv.FIsLittleEndian);
          p += 4;
          for (var $l2 = 0, $end2 = s.length - 1; $l2 <= $end2; $l2++) {
            j = $l2;
            View.setUint16(p,s.charCodeAt((j + 1) - 1),this.FEnv.FIsLittleEndian);
            p += 2;
          };
          ...
          View.setInt32(p,NewId,this.FEnv.FIsLittleEndian);
          p += 4;
        } else {
          View.setUint8(p,0);
          p += 1;
    ...
    this.EatCallbackResult = function (View, ResultP) {
      ...
      function EatString() {
        ...
        var i = 0;
        var a = [];
        Len = View.getUint32(p,$Self.FEnv.FIsLittleEndian);
        p += 4;
        a = rtl.arraySetLength(a,0,Len);
        for (var $l = 0, $end = Len - 1; $l <= $end; $l++) {
          i = $l;
          a[i] = View.getUint16(p,$Self.FEnv.FIsLittleEndian);
          p += 2;
        };
      ...
      try {
        ...
        if ($tmp === 3) {
          ...
          Result = View.getInt32(p,this.FEnv.FIsLittleEndian)}
         else if ($tmp === 2) {
          Result = View.getFloat64(p,this.FEnv.FIsLittleEndian)}
         else if ($tmp === 7) {
          Result = EatString()}
         else if ($tmp === 8) {
          Result = null}
         else if ($tmp === 10) {
          ObjId = View.getInt32(p,this.FEnv.FIsLittleEndian);
    ...
    this.Get_GlobalID = function (NameP, NameLen) {
      ...
      aName = $impl.TypedArrayToString(aWords);
    ...
    this.Invoke_DoubleResult = function (ObjId, NameP, NameLen, Invoke, ArgsP, ResultP) {
      ...
      this.getModuleMemoryDataView().setFloat64(ResultP,rtl.getNumber(JSResult),this.FEnv.FIsLittleEndian);
      Result = 8;
      return Result;
    };
    this.Invoke_StringResult = function (ObjId, NameP, NameLen, Invoke, ArgsP, ResultP) {
      ...
      this.getModuleMemoryDataView().setInt32(ResultP,this.FStringResult.length,this.FEnv.FIsLittleEndian);
      return Result;
    };
    this.Invoke_ObjectResult = function (ObjId, NameP, NameLen, Invoke, ArgsP, ResultP) {
      ...
      this.getModuleMemoryDataView().setUint32(ResultP,NewId >>> 0,this.FEnv.FIsLittleEndian);
      Result = 11;
      return Result;
    };
    this.Create_JSObject = function (NameP, NameLen, ArgsP) {
      ...
      View = this.getModuleMemoryDataView();
      aWords = new Uint16Array(View.buffer,NameP,NameLen);
      ObjName = $impl.TypedArrayToString(aWords);
      ...
      if (!(typeof(JSResult) === "object")) {
        Result = 0}
       else Result = this.RegisterLocalObject(JSResult);
      return Result;
    };
    ...
    this.GetStringResult = function (ResultP) {
      ...
      for (var $l = 0, $end = l - 1; $l <= $end; $l++) {
        i = $l;
        View.setUint16(ResultP + (2 * i),this.FStringResult.charCodeAt((i + 1) - 1),this.FEnv.FIsLittleEndian);
      };
      this.FStringResult = "";
      return Result;
    };
    ...
    this.RegisterLocalObject = function (Obj) {
      var Result = 0;
      var NewId = undefined;
      NewId = this.FFreeLocalIds.pop();
      if (pas.JS.isUndefined(NewId)) {
        NewId = this.FLocalObjects.push(Obj) - 1;
        Result = rtl.trunc(NewId);
      } else {
        Result = rtl.trunc(NewId);
        this.FLocalObjects[Result] = Obj;
      };
      return Result;
    };
  ...
  $mod.$implcode = function () {
    $impl.TypedArrayToString = function (a) {
...
rtl.module("libzenfs",["System","JS","Web","Types"],function () {
  "use strict";
  var $mod = this;
});
rtl.module("wasizenfs",["System","SysUtils","JS","libzenfs","wasitypes"],function () {
  "use strict";
  var $mod = this;
  var $impl = $mod.$impl;
  rtl.createClass(this,"EWASIZenFS",pas.SysUtils.Exception,function () {
  });
  rtl.createClass(this,"TWASIZenFS",pas.System.TObject,function () {
    this.$init = function () {
      pas.System.TObject.$init.call(this);
      this.FRoot = null;
      this.FDirMap = null;
    ...
    this.$final = function () {
      ...
      this.FDirMap = undefined;
      pas.System.TObject.$final.call(this);
    };
    this.AllocateDirFD = function (aDir) {
      var Result = 0;
      var I = 0;
      I = 4;
      while ((I < 100) && this.FDirMap.has(I)) I += 1;
      if (I === 100) throw $mod.EWASIZenFS.$create("Create$1",["Too many directories"]);
      this.FDirMap.set(I,aDir);
      Result = I;
      return Result;
    };
    this.IsDirEnt = function (FD) {
      var Result = [];
      if (this.FDirMap.has(FD)) {
        Result = this.FDirMap.get(FD)}
       else Result = [];
      return Result;
    };
    this.RemoveDirent = function (FD) {
      this.FDirMap.delete(FD);
    };
    this.PrependFD = function (FD, aPath) {
      var Result = "";
      if (FD !== 3) pas.System.Writeln("Warning, unknown CWD ID",FD);
      Result = "/" + aPath;
      return Result;
    };
    this.ExceptToError = function (E) {
      var Result = 0;
      if (E != null) ;
      Result = 52;
      return Result;
    };
    this.ZenFSDateToWasiTimeStamp = function (aDate) {
      var Result = 0;
      Result = aDate.getTime();
      return Result;
    };
    this.ZenStatToWasiStat = function (ZSTat) {
      var Result = pas.wasitypes.__wasi_filestat_t.$new();
      Result.dev = 0;
      Result.ino = 0;
      if (ZSTat.isDirectory()) {
        Result.filetype = 3}
       else if (ZSTat.isBlockDevice()) {
        Result.filetype = 1}
       else if (ZSTat.isCharacterDevice()) {
        Result.filetype = 2}
       else if (ZSTat.isFile()) {
        Result.filetype = 4}
       else if (ZSTat.isSocket()) {
        Result.filetype = 5}
       else if (ZSTat.isSymbolicLink()) {
        Result.filetype = 7}
       else Result.filetype = 0;
      Result.nlink = pas.JS.AsIntNumber(ZSTat.nlink);
      Result.size = pas.JS.AsIntNumber(ZSTat.size);
      Result.atim = this.ZenFSDateToWasiTimeStamp(ZSTat.atime);
      Result.mtim = this.ZenFSDateToWasiTimeStamp(ZSTat.mtime);
      Result.ctim = this.ZenFSDateToWasiTimeStamp(ZSTat.ctime);
      return Result;
    };
    this.create$1 = function () {
      this.FDirMap = new Map();
      return this;
    };
    this.MkDirAt = function (FD, aPath) {
      var Result = 0;
      try {
        ZenFS.mkdirSync(this.PrependFD(FD,aPath),511);
        Result = 0;
      } catch ($e) {
        if (rtl.isExt($e,Object)) {
          var E = $e;
          Result = this.$class.ExceptToError(E);
        } else throw $e
      };
      return Result;
    };
    this.RmDirAt = function (FD, aPath) {
      var Result = 0;
      try {
        ZenFS.rmdirSync(this.PrependFD(FD,aPath));
        Result = 0;
      } catch ($e) {
        if (rtl.isExt($e,Object)) {
          var E = $e;
    ...
    this.StatAt = function (FD, aPath, stat) {
      var Result = 0;
      var ZStat = null;
      try {
        ZStat = ZenFS.statSync(this.PrependFD(FD,aPath));
        stat.$assign(this.$class.ZenStatToWasiStat(ZStat));
        Result = 0;
      } catch ($e) {
        if (rtl.isExt($e,Object)) {
          var E = $e;
    ...
    this.UTimesAt = function (FD, aPath, aTime, MTime, UpdateLink) {
      var Result = 0;
      var lPath = "";
      lPath = this.PrependFD(FD,aPath);
      try {
        if (UpdateLink) {
          ZenFS.lutimesSync(lPath,aTime,MTime)}
         else ZenFS.utimesSync(lPath,aTime,MTime);
        Result = 0;
      } catch ($e) {
        if (rtl.isExt($e,Object)) {
          var E = $e;
    ...
    this.UTimes = function (FD, aTime, MTime, Flags) {
      var Result = 0;
      try {
    ...
    this.LinkAt = function (OldFD, OldPath, NewFD, NewPath) {
      var Result = 0;
      var lOld = "";
      var lNew = "";
      lOld = this.PrependFD(OldFD,OldPath);
      lNew = this.PrependFD(NewFD,NewPath);
      try {
    ...
    this.RenameAt = function (OldFD, OldPath, NewFD, NewPath) {
      var Result = 0;
      var lOld = "";
      var lNew = "";
      lOld = this.PrependFD(OldFD,OldPath);
    ...
    this.SymLinkAt = function (FD, Path, Target) {
      var Result = 0;
      var lPath = "";
      lPath = this.PrependFD(FD,Path);
      try {
    ...
    this.UnLinkAt = function (FD, aPath) {
      var Result = 0;
      var lPath = "";
      lPath = this.PrependFD(FD,aPath);
      try {
    ...
    this.OpenAt = function (FD, FDFlags, aPath, Flags, fsRightsBase, fsRightsInheriting, fsFlags, Openfd) {
      var $Self = this;
      var Result = 0;
      var lPath = "";
      var lFlags = "";
      ...
      var Dir = [];
      var Opts = null;
      function HasFlag(aFlag) {
        var Result = false;
        Result = (Flags & aFlag) !== 0;
        return Result;
      };
      function HasRight(aRight) {
        var Result = false;
        if (pas.JS.isBigint(Rights)) {
          Result = ((Rights & BigInt(aRight)) != 0);
        } else Result = (Rights & aRight) !== 0;
        return Result;
      };
      if ((FDFlags !== 0) && (fsFlags !== 0)) ;
      lPath = this.PrependFD(FD,aPath);
      if (!HasFlag(2)) {
        Rights = pas.JS.AsIntNumber(fsRightsBase);
        Writing = HasFlag(1) || HasRight(64);
        Reading = HasRight(2);
        if (Writing) {
          if (HasFlag(8)) {
            lFlags = "w"}
           else lFlags = "a";
          if (HasFlag(4)) lFlags = lFlags + "x";
          if (Reading) lFlags = lFlags + "+";
        } else {
          lFlags = "r";
        };
      };
      try {
        if (HasFlag(2)) {
          ...
          Dir = ZenFS.readdirSync(lPath,Opts);
          Openfd.set(this.AllocateDirFD(rtl.arrayRef(Dir)));
        } else Openfd.set(ZenFS.openSync(lPath,lFlags));
        Result = 0;
      } catch ($e) {
        if (rtl.isExt($e,Object)) {
          var E = $e;
    ...
    this.ReadLinkAt = function (FD, aPath, aTarget) {
      var Result = 0;
      var lPath = "";
      lPath = this.PrependFD(FD,aPath);
      try {
        aTarget.set(ZenFS.readlinkSync(lPath));
        Result = 0;
      } catch ($e) {
        if (rtl.isExt($e,Object)) {
          var E = $e;
    ...
    this.Close = function (FD) {
      var Result = 0;
      try {
        if (rtl.length(this.IsDirEnt(FD)) > 0) {
          this.RemoveDirent(FD);
          Result = 0;
        } else ZenFS.closeSync(FD);
        Result = 0;
      } catch ($e) {
        if (rtl.isExt($e,Object)) {
          var E = $e;
    ...
    this.Write = function (FD, Data, AtPos, Written) {
      var Result = 0;
      var DS = null;
      try {
        DS = new DataView(Data.buffer);
        if (AtPos !== -1) {
          Written.set(ZenFS.writeSync(FD,DS,AtPos))}
         else Written.set(ZenFS.writeSync(FD,DS,0,Data.byteLength));
        Result = 0;
      } catch ($e) {
        if (rtl.isExt($e,Object)) {
          var E = $e;
    ...
    this.Seek = function (FD, Offset, Whence, NewPos) {
      var Result = 0;
      var aPos = 0;
      var F = null;
      var Stat = null;
      try {
        var $tmp = Whence;
        if ($tmp === 0) {
          aPos = pas.JS.AsIntNumber(Offset)}
         else if ($tmp === 1) {
          F = fd2file(FD);
          if (F != null) {
            aPos = pas.JS.AsIntNumber(F.position) + pas.JS.AsIntNumber(Offset)}
           else throw new ZenFS.ErrnoError(9);
        } else if ($tmp === 2) {
          Stat = ZenFS.fstatSync(FD);
          aPos = pas.JS.AsIntNumber(Stat.size) + pas.JS.AsIntNumber(Offset);
        };
        ZenFS.readSync(FD,null,0,0,aPos);
        NewPos.set(aPos);
        Result = 0;
      } catch ($e) {
        if (rtl.isExt($e,Object)) {
    ...
    this.Read = function (FD, Data, AtPos, BytesRead) {
      var Result = 0;
      var V = null;
      var opts = null;
      ...
      try {
        ...
        if (AtPos !== -1) opts.position = AtPos;
        BytesRead.set(ZenFS.readSync(FD,V,opts));
        Result = 0;
      } catch ($e) {
        if (rtl.isExt($e,Object)) {
          var E = $e;
    ...
    this.ReadDir = function (FD, Cookie, DirEnt) {
      var Result = 0;
      var DirEnts = [];
      var ZDirEntry = null;
      DirEnts = this.IsDirEnt(FD);
      if (!(rtl.length(DirEnts) > 0)) return 8;
      if ((Cookie < 0) || (Cookie >= rtl.length(DirEnts))) return 44;
      ZDirEntry = DirEnts[Cookie];
      DirEnt.name = ZDirEntry.path;
      if (ZDirEntry.isFile()) {
        DirEnt.EntryType = 1}
       else if (ZDirEntry.isDirectory()) {
        DirEnt.EntryType = 2}
       else if (ZDirEntry.isSymbolicLink()) {
        DirEnt.EntryType = 3}
       else if (ZDirEntry.isFIFO()) {
        DirEnt.EntryType = 7}
       else if (ZDirEntry.isBlockDevice()) {
        DirEnt.EntryType = 5}
       else if (ZDirEntry.isCharacterDevice()) {
        DirEnt.EntryType = 6}
       else if (ZDirEntry.isSocket()) DirEnt.EntryType = 4;
      DirEnt.next = Cookie + 1;
      Result = 0;
      return Result;
    };
    this.GetPrestat = function (FD) {
      var Result = "";
      if (FD === 3) {
        this.FRoot = ZenFS.opendirSync("/");
        Result = "/";
      };
      return Result;
    };
...
rtl.module("program",["System","browserconsole","BrowserApp","wasihostapp","JOB_Browser","JS","Classes","SysUtils","Web","wasitypes","wasizenfs","libzenfs","wasienv"],function () {
  "use strict";
  var $mod = this;
  rtl.createClass(this,"Tjs_leaflet",pas.wasihostapp.TBrowserWASIHostApplication,function () {
    this.$init = function () {
      pas.wasihostapp.TBrowserWASIHostApplication.$init.call(this);
      this.FS = null;
      this.ob = null;
      this.sd = pas.wasienv.TWebAssemblyStartDescriptor.$new();
    };
    this.$final = function () {
      this.FS = undefined;
      this.ob = undefined;
    ...
    this.RunWasm = async function () {
      ...
      this.StartWebAssembly("wasm_leaflet.wasm",true,rtl.createCallback(this,"wasmBeforeStart"),null);
    };
    this.DoRun = function () {
      this.RunWasm();
    };
    ...
    this.wasmWrite = function (Sender, aOutput) {
      pas.System.Writeln(aOutput);
    };
    this.Create$1 = function (aOwner) {
      pas.wasihostapp.TBrowserWASIHostApplication.Create$1.call(this,aOwner);
      this.ob = pas.JOB_Browser.TJSObjectBridge.$create("Create$1",[this.GetEnv()]);
  ...
  $mod.$main = function () {
    ...
    $mod.Application = $mod.Tjs_leaflet.$create("Create$1",[null]);
    $mod.Application.Initialize();
    $mod.Application.Run();
  };
});
//# sourceMappingURL=js_leaflet.js.map
