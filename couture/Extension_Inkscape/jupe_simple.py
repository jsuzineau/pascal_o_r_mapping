...
class JupeEffect(inkex.Effect):
    ...
    def effect(self):
        ...
        g_attribs = { inkex.addNS('label','inkscape'): 'Patron Jupe simple',
    ...
    def Quartiers( self, _svg):
        ...
        y=0;
        y=self.svg_Qc( _svg, self.uu_rayon_cote, self.uu_rayon_av  , y, 0)
        y=self.svg_Qc( _svg, self.uu_rayon_av  , self.uu_rayon_cote, y, 1)
        y=self.svg_Qc( _svg, self.uu_rayon_cote, self.uu_rayon_ar  , y, 2)
        y=self.svg_Qc( _svg, self.uu_rayon_ar  , self.uu_rayon_cote, y, 3)
        self.svg_Log_xy( _svg, 0, y)
    def Quartiers_non_complexes( self, _svg):
        print >>self.tty, 'Quartiers début'
        y=0;
        y=self.svg_Q( _svg, self.uu_rayon_cote, self.uu_rayon_av  , y, 0)
        y=self.svg_Q( _svg, self.uu_rayon_av  , self.uu_rayon_cote, y, 1)
        y=self.svg_Q( _svg, self.uu_rayon_cote, self.uu_rayon_ar  , y, 2)
        y=self.svg_Q( _svg, self.uu_rayon_ar  , self.uu_rayon_cote, y, 3)
        self.svg_Log_xy( _svg, 0, y)
    def Quartiers_Ligne( self, _svg):
        y=0;
        y_step=200

        cx= 2*self.uu_rayon_cote
        cy= self.uu_rayon_av
        #self.createGuide( cx, cy, 0)
        self.Q4( _svg, 'translate(%f,%f) rotate(%f,%f,%f)'%(-cx,y-cy,-135,cx,cy));

        y+=y_step;
        cx= 0#self.uu_rayon_cote
        cy= self.uu_rayon_av
        self.Q5( _svg, 'translate(%f,%f) rotate(%f,%f,%f)'%(3.0/2*self.uu_rayon_cote,y-cy,135,cx,cy));
    ...
    def Quartiers_en_place( self, _svg):
        ...
        self.Q6( _svg);
        self.Q7( _svg);
        self.svg_Log_xy( _svg, self.uu_rayon_cote/4, self.uu_rayon_av+self.uu_rayon_disque)

    def Q4( self, _svg, _transform=''): self.svg_bord( _svg, self.uu_rayon_cote,self.uu_rayon_ar    , self.uu_rayon_cote, self.uu_rayon_av, 0, 1, 1, _transform, 'Q4')
    def Q5( self, _svg, _transform=''): self.svg_bord( _svg, self.uu_rayon_cote,self.uu_rayon_ar    , self.uu_rayon_cote, self.uu_rayon_av, 1, 1, 1, _transform, 'Q5')
    def Q6( self, _svg, _transform=''): self.svg_bord( _svg, self.uu_rayon_cote,self.uu_rayon_av    , self.uu_rayon_cote, self.uu_rayon_av, 2, 1, 1, _transform, 'Q6')
    def Q7( self, _svg, _transform=''): self.svg_bord( _svg, self.uu_rayon_cote,self.uu_rayon_av    , self.uu_rayon_cote, self.uu_rayon_av, 3, 1, 1, _transform, 'Q7')
    def Moitie( self, _svg):
        self.svg_text   ( _svg, self.uu_rayon_cote-self.uu_rayon_disque/2, self.uu_rayon_av, 'AV')
        self.svg_ellipse( _svg, self.uu_rayon_disque,self.uu_rayon_disque, self.uu_rayon_cote, self.uu_rayon_av, 1, 2)
        self.svg_ellipse( _svg, self.uu_rayon_cote  ,self.uu_rayon_av    , self.uu_rayon_cote, self.uu_rayon_av, 2, 1)
        self.svg_ellipse( _svg, self.uu_rayon_cote  ,self.uu_rayon_ar    , self.uu_rayon_cote, self.uu_rayon_av, 1, 1)
        self.svg_Log_xy ( _svg, self.uu_rayon_cote/4, self.uu_rayon_av+self.uu_rayon_disque)

    def Complet( self, _svg):
        self.svg_text   ( _svg, self.uu_rayon_cote-self.uu_rayon_disque/2, self.uu_rayon_av, 'AV')
        self.svg_ellipse( _svg, self.uu_rayon_disque ,self.uu_rayon_disque, self.uu_rayon_cote, self.uu_rayon_av, 0,4)
        self.svg_ellipse( _svg, self.uu_rayon_cote,self.uu_rayon_av, self.uu_rayon_cote, self.uu_rayon_av, 2,2)
        self.svg_ellipse( _svg, self.uu_rayon_cote,self.uu_rayon_ar, self.uu_rayon_cote, self.uu_rayon_av, 0,2)
        self.svg_Log_xy ( _svg, self.uu_rayon_cote/4, self.uu_rayon_av+self.uu_rayon_disque)
