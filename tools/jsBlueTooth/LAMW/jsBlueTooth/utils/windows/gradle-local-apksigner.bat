...
zipalign -v -p 4 E:\01_Projets\01_pascal_o_r_mapping\tools\jsBlueTooth\LAMW\jsBlueTooth\build\outputs\apk\release\jsBlueTooth-armeabi-v7a-release-unsigned.apk E:\01_Projets\01_pascal_o_r_mapping\tools\jsBlueTooth\LAMW\jsBlueTooth\build\outputs\apk\release\jsBlueTooth-armeabi-v7a-release-unsigned-aligned.apk
