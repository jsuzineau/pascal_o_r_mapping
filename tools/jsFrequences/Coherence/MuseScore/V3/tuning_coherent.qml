...
MuseScore {
    ...
    property var coherent:
        {
                   // C     G     D     A  E     B     F#      C#     G#     Eb      Bb      F
        'offsets': [-5.87,-3.91, -1.96, 0, 1.96, 3.91, 6.81, -14.97, -13.87, -13.48, -9.82, -8.50],
        'root': 0,
        'pure': 3,
        'name': "coherent"
        }
            ...
            GroupBox {
                ...
                ColumnLayout {
                    ...
                    RadioButton {
                        ...
                        text: "Cohérent"
                        exclusiveGroup: tempamentTypeGroup
                        onClicked: { temperamentClicked(coherent) }
                    }
                    RadioButton {
