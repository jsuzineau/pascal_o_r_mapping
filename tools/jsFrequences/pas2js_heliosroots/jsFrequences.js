...
rtl.module("uFrequences",["System","Classes","SysUtils","uFrequence"],function () {
  "use strict";
  var $mod = this;
  var $impl = $mod.$impl;
  ...
  rtl.createClass($mod,"TFrequences",pas.System.TObject,function () {
    this.sFrequence = function (_OctaveFactor, _Base) {
      var Result = "";
      var Frequence = 0.0;
      var Bas = 0.0;
      var Haut = 0.0;
    ...
    this.Match_Base = function (_OctaveFactor, _Base, _Frequence, _Prefixe, _Nb) {
      ...
      var Bas = 0.0;
      var Haut = 0.0;
      F = _Base * Math.pow(2,_OctaveFactor);
      Bas = F * 0.9915;
      Haut = F * 1.0085;
      if ((Bas <= _Frequence) && (_Frequence <= Haut)) {
        Result = (_Prefixe + " ") + this.sFrequence(_OctaveFactor,_Base);
        _Nb.set(_Nb.get() + 1);
      } else Result = "";
      return Result;
    };
    this.sMatch = function (_OctaveFactor, _Frequence, _NbCoherent, _NbDeCoherent) {
      var Result = "";
      var I = 0;
      Result = "";
      for (I = 0; I <= 11; I++) Result = Result + this.Match_Base(_OctaveFactor,$mod.uFrequences_coherent[I],_Frequence,"cohérent",_NbCoherent);
      for (I = 0; I <= 11; I++) Result = Result + this.Match_Base(_OctaveFactor + 1,$mod.uFrequences_coherent[I],_Frequence,"cohérent",_NbCoherent);
      for (I = 0; I <= 11; I++) Result = Result + this.Match_Base(_OctaveFactor,$mod.uFrequences_decoherent[I],_Frequence,"décohérent",_NbDeCoherent);
      for (I = 0; I <= 11; I++) Result = Result + this.Match_Base(_OctaveFactor + 1,$mod.uFrequences_decoherent[I],_Frequence,"décohérent",_NbDeCoherent);
      return Result;
    };
  });
    ...
    this.Changed = function () {
      ...
      if (!this.IsUpdating()) {
        ...
        if ($tmp4 === 2) {
          ...
          VTd.style.setProperty("text-align","left")}
         else if ($tmp4 === 1) VTd.style.setProperty("text-align","right");
        var $tmp5 = this.FLayout;
        if ($tmp5 === 2) {
          VTd.style.setProperty("vertical-align","bottom")}
         else if ($tmp5 === 1) {
          VTd.style.setProperty("vertical-align","middle")}
         else if ($tmp5 === 0) VTd.style.setProperty("vertical-align","top");
        if (this.FWordWrap) {
          VTd.style.setProperty("word-wrap","break-word");
        } else {
          VTd.style.removeProperty("word-wrap");
  ...
  rtl.createClass($mod,"TfjsFrequences",pas.WebCtrls.TWForm,function () {
    ...
    this.Loaded = function () {
      ...
      try {
        ...
        this.SetText("fjsFrequences");
        this.SetClientHeight(490);
        this.SetClientWidth(793);
        this.WPanel1 = pas.WebCtrls.TWPanel.$create("Create$1",[this]);
        this.WPanel1.BeginUpdate();
        try {
          this.WPanel1.SetParent(this);
          this.WPanel1.SetLeft(0);
          this.WPanel1.SetHeight(48);
          this.WPanel1.SetTop(0);
          this.WPanel1.SetWidth(793);
          this.WPanel1.SetAlign(1);
          this.WPanel1.SetClientHeight(48);
          this.WPanel1.SetClientWidth(793);
          this.WPanel1.SetTabOrder(0);
          this.WLabel1 = pas.WebCtrls.TWLabel.$create("Create$1",[this.WPanel1]);
          this.WLabel1.BeginUpdate();
          try {
            this.WLabel1.SetParent(this.WPanel1);
            this.WLabel1.SetLeft(24);
            this.WLabel1.SetHeight(40);
            this.WLabel1.SetTop(7);
            this.WLabel1.SetWidth(183);
            this.WLabel1.SetAutoSize(false);
            this.WLabel1.SetText("Octave factor");
...
rtl.module("program",["System","Forms","ufjsFrequences","uFrequences","uCPL_G3","uFrequence"],function () {
  "use strict";
  var $mod = this;
  $mod.$main = function () {
    pas.Forms.Application().Initialize();
    pas.Forms.Application().CreateForm(pas.ufjsFrequences.TfjsFrequences,{p: pas.ufjsFrequences, get: function () {
        return this.p.fjsFrequences;
      }, set: function (v) {
        this.p.fjsFrequences = v;
      }});
