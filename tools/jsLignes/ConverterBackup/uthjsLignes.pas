...
type
    ...
    =
     class(TThread)
     public
       constructor Create( aRootPath: String; unExclus: TStrings);
...
constructor TthjsLignes.Create( aRootPath: String; unExclus: TStrings);
begin
     RootPath:= aRootPath;
     Exclus:= TStringList.Create;
     Exclus.Assign( unExclus);
