     ...
     cSymetric.NomSymetric:= Champs.String_Lookup( FSymetric.NomSymetric, 'Symetric.NomSymetric', cSymetric.NomSymetric_id, ublClasse.Nom_de_la_classe_poolSymetric.ClasseSymetric.GetLookupListItems, '');
