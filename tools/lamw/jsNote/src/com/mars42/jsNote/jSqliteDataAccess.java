...
class SQLiteAssetHelper extends SQLiteOpenHelper
    ...
    private SQLiteDatabase createOrOpenDatabase(boolean force) throws SQLiteAssetException
        ...
        if (db != null)
            ...
            {
            Log.w(TAG, "createOrOpenDatabase db == null), path: "+DB_PATH+"/"+DATABASE_NAME );
    ...
    public SQLiteDatabase returnDatabase(String dbPath, String dbName) throws IOException
        { //by jmpessoa
...
// io chiamo super
    ...
    public String Select(String selectQuery)
        { //return String
    ...
    public boolean Select(String selectQuery, boolean moveToLast)
        { //just set the cursor! return void..
    ...
    public String GetValueToString(int columnIndex)
        ...
        switch (mCursor.getType(columnIndex))
            {
            case Cursor.FIELD_TYPE_INTEGER:
                colValue = Integer.toString(mCursor.getInt(columnIndex));
                break;
            case Cursor.FIELD_TYPE_STRING:
                colValue = mCursor.getString(columnIndex);
                break;
            case Cursor.FIELD_TYPE_FLOAT:
                colValue = String.format(Locale.US, "%.2f", mCursor.getFloat(columnIndex));
                break;
            case Cursor.FIELD_TYPE_BLOB:
                colValue = "BLOB";
                break;
    ...
    class BatchTask extends AsyncTask<String, Void, String>
        ...
        public BatchTask(SQLiteDatabase _mydb, int _task)
            ...
            switch (taskType)
                {
                case 0:
                    msgResult = "[Async Unknown Task] Fail to Execute SQL...";
                    break;
                case 1:
                    msgResult = "[Async Update Task] Fail to Execute  SQL...";
                    break;
                case 2:
                    msgResult = "[Async Insert Task] Fail to Execute SQL...";
                    break;
                }
            }
        ...
        protected String doInBackground(String... args)
            ...
            switch (taskType)
                {
                case 0:
                    msgResult = "[Async Unknown Task]Success!! SQL Queries Executed!";
                    break;
                case 1:
                    msgResult = "[Async Update Task] Success!! SQL Queries Executed!";
                    break;
                case 2:
                    msgResult = "[Async Insert Task] Success!! SQL Queries Executed!";
                    break;
                }
