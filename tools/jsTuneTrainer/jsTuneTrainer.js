...
rtl.module("program",["System","browserconsole","JS","Classes","SysUtils","Web","websvg","Types"],function () {
  "use strict";
  var $mod = this;
  this.dump_element_variables = function (_id) {
    var o = null;
    var s = "";
    o = document.getElementById(_id);
    pas.System.Writeln("dump_element_variables(",_id,"): keys");
    for (var $in = Object.keys(o), $l = 0, $end = rtl.length($in) - 1; $l <= $end; $l++) {
      s = $in[$l];
      pas.System.Writeln("  ",s);
    };
    pas.System.Writeln("dump_element_variables(",_id,"): to_string");
    pas.System.Writeln("  ",o.toString());
    pas.System.Writeln("dump_element_variables(",_id,"): OwnPropertyNames");
    for (var $in1 = Object.getOwnPropertyNames(o), $l1 = 0, $end1 = rtl.length($in1) - 1; $l1 <= $end1; $l1++) {
      s = $in1[$l1];
      pas.System.Writeln("  ",s);
    };
  };
  this.on_click = function (Event) {
    var Result = false;
    pas.System.Writeln("clicked");
    return Result;
  };
  this.Set_on_click = function (_id) {
    var et = null;
    et = document.getElementById(_id);
    et.addEventListener("click",rtl.createSafeCallback($mod,"on_click"));
  };
  this.dump_element_attributes = function (_name, _e) {
    var attributes = null;
    var i = 0;
    var attr = null;
    pas.System.Writeln("dump_element_attributes(",_name,"): attributes");
    attributes = _e.attributes;
    for (var $l = 0, $end = attributes.length - 1; $l <= $end; $l++) {
      i = $l;
      attr = attributes.item(i);
      pas.System.Writeln("  name:",attr.name," value:",attr.value," prefix:",attr.prefix," localName:",attr.localName," namespaceURI:",attr.namespaceURI);
    };
  };
  this.Ecart_x = 400;
  this.x = 0;
  this.Copie = function (_svg_id, _id) {
    var c = null;
    var copie = null;
    var parent = null;
    var style = "";
    var i = 0;
    $mod.x += 400;
    parent = document.getElementById(_svg_id);
    pas.System.Writeln("Copie(",_id,"): parent.to_string");
    pas.System.Writeln("  ",parent.toString());
    c = document.getElementById(_id);
    copie = c.cloneNode(true);
    copie.setAttribute("id",_id + "_copie");
    copie.setAttribute("cx",pas.SysUtils.IntToStr($mod.x));
    ...
    pas.System.Writeln("Copie(",_id,"): copie.to_string");
    pas.System.Writeln("  ",copie.toString());
    $mod.dump_element_variables(_id);
    $mod.dump_element_attributes("c",c);
    $mod.dump_element_attributes("copie",copie);
  };
  $mod.$main = function () {
    $mod.dump_element_variables("C4");
    $mod.Set_on_click("C4");
    $mod.Copie("svg2","G4");
    $mod.Copie("svg2","A4");
    $mod.Copie("svg2","F4");
