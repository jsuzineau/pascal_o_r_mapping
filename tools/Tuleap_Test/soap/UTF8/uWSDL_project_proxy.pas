...
This unit has been produced by ws_helper.
  ...
  This unit name  : "uWSDL_project_proxy".
  Date            : "21/12/2015 18:48:32".
}

Unit uWSDL_project_proxy;
{$IFDEF FPC} {$mode objfpc}{$H+} {$ENDIF}
Interface

Uses SysUtils, Classes, TypInfo, base_service_intf, service_intf, uWSDL_project;

Type


  TTuleapProjectAPIPortType_Proxy=class(TBaseProxy,uWSDL_project.TuleapProjectAPIPortType)
  Protected
...
begin
  result := TypeInfo(uWSDL_project.TuleapProjectAPIPortType);
end;
...
initialization
  ...
  {$IF DECLARED(Register_uWSDL_project_ServiceMetadata)}
  Register_uWSDL_project_ServiceMetadata();
  {$IFEND}
End.
