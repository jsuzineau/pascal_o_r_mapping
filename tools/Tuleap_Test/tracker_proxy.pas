...
Uses SysUtils, Classes, TypInfo, base_service_intf, service_intf, tracker;

Type


  TTuleapTrackerV5APIPortType_Proxy=class(TBaseProxy,tracker.TuleapTrackerV5APIPortType)
  Protected
...
begin
  result := TypeInfo(tracker.TuleapTrackerV5APIPortType);
end;
...
initialization
  ...
  {$IF DECLARED(Register_tracker_ServiceMetadata)}
  Register_tracker_ServiceMetadata();
  {$IFEND}
End.
