...
Uses SysUtils, Classes, TypInfo, base_service_intf, service_intf, svn;

Type


  TTuleapSubversionAPIPortType_Proxy=class(TBaseProxy,svn.TuleapSubversionAPIPortType)
  Protected
...
begin
  result := TypeInfo(svn.TuleapSubversionAPIPortType);
end;
...
initialization
  ...
  {$IF DECLARED(Register_svn_ServiceMetadata)}
  Register_svn_ServiceMetadata();
  {$IFEND}
End.
