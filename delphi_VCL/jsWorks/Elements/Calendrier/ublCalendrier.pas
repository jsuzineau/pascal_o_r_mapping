...
begin
     ...
     _Cumul.cTotal:= Ajoute_DateTime( _Cumul.Cumul.Total, Prefixe+'Total', False);
     _Cumul.cTotal.OnGetChaine:= _Cumul.Total_GetChaine;

     _Cumul.cDepassement:= Ajoute_DateTime( _Cumul.Cumul.Depassement, Prefixe+'Depassement', False);
