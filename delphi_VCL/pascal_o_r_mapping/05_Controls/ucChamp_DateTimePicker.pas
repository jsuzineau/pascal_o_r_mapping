...
uses
  ...
  LCLType,
  {$ENDIF}
  SysUtils, Classes, VCL.Controls, DB, Messages,VCL.StdCtrls, VCL.ExtCtrls,
  VCL.ComCtrls,
    RTLConsts;
...
type
 ...
 TChamp_DateTimePicker
 =
  class(TDateTimePicker, IChampsComponent)
  //Cycle de vie
  public
  ...
  //Général
  protected
    procedure DoDateTimeChangedByUser;// à revoir override;
  //Propriété Champs
  private
    FChamps: TChamps;
...
procedure TChamp_DateTimePicker.DoDateTimeChangedByUser;
begin
     inherited;
     if not Champ_OK then exit;
