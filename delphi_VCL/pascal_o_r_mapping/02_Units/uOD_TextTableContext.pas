...
uses
    ...
    uOpenDocument,
  SysUtils, Classes,
  Windows, Variants, VCL.Dialogs,VCL.Grids,
  DB;
...
type
 ...
 =
  ...
  //Cycle de vie
  public
    constructor Create( _D: TOpenDocument; _eRoot: TJclSimpleXMLElem); override;
...
constructor TOD_TABLE_CELL.Create( _D: TOpenDocument; _eRoot: TJclSimpleXMLElem);
begin
     inherited;
...
constructor TOD_TABLE_ROW.Create( _D: TOpenDocument; _eRoot: TJclSimpleXMLElem);
begin
     inherited;
...
constructor TOD_TABLE_HEADER_ROWS.Create( _D: TOpenDocument; _eRoot: TJclSimpleXMLElem);
begin
     inherited;
...
constructor TOD_TABLE_COLUMN.Create( _D: TOpenDocument; _eRoot: TJclSimpleXMLElem);
begin
     inherited;
...
begin
     Result:= C( D.odeContent.xml.Root);
end;
