...
type
 ...
 =
  ...
  private
    procedure sljpfMembre_from_sRepertoireListeMembres_FileFound( _NomFichier: String);
  public
  ...
  private
    procedure sljpfDetail_from_sRepertoireListeDetails_FileFound( _NomFichier: String);
  public
  ...
  private
    procedure sljpfSymetric_from_sRepertoireListeSymetrics_FileFound( _NomFichier: String);
  public
  ...
  private
    procedure sljpfAggregation_from_sRepertoireListeAggregations_FileFound( _NomFichier: String);
  public
  ...
  private
    procedure slApplicationJoinPointFile_from_sRepertoireListeTables_FileFound( _NomFichier: String);
  public
  ...
  public
    ...
    procedure Cree_TemplateHandler( var _Reference;
                                   _Source: String;
                                   _slParametres: TBatpro_StringList= nil); overload; override;
  ...
  private
    procedure slTemplateHandler_from_sRepertoireTemplate_FileFound( _NomFichier: String);
  public
  ...
  //Création des TemplateHandler par lecture du répertoire de modèles
  private
    procedure slApplicationTemplateHandler_from_sRepertoireApplicationTemplate_FileFound( _NomFichier: String);
  public
...
procedure TGenerateur_de_code.sljpfMembre_from_sRepertoireListeMembres_FileFound( _NomFichier: String);
var
   NomFichier_Key: String;
begin
     NomFichier_Key:= _NomFichier;
...
procedure TGenerateur_de_code.sljpfDetail_from_sRepertoireListeDetails_FileFound( _NomFichier: String);
var
   NomFichier_Key: String;
begin
     NomFichier_Key:= _NomFichier;
...
procedure TGenerateur_de_code.sljpfSymetric_from_sRepertoireListeSymetrics_FileFound( _NomFichier: String);
var
   NomFichier_Key: String;
begin
     NomFichier_Key:= _NomFichier;
...
procedure TGenerateur_de_code.sljpfAggregation_from_sRepertoireListeAggregations_FileFound( _NomFichier: String);
var
   NomFichier_Key: String;
begin
     NomFichier_Key:= _NomFichier;
...
procedure TGenerateur_de_code.slApplicationJoinPointFile_from_sRepertoireListeTables_FileFound( _NomFichier: String);
var
   NomFichier_Key: String;
begin
     NomFichier_Key:= _NomFichier;
...
procedure TGenerateur_de_code.slTemplateHandler_from_sRepertoireTemplate_FileFound( _NomFichier: String);
var
   Source: String;
begin
     Source:= _NomFichier;
...
procedure TGenerateur_de_code.slApplicationTemplateHandler_from_sRepertoireApplicationTemplate_FileFound( _NomFichier: String);
var
   Source: String;
begin
     Source:= _NomFichier;
