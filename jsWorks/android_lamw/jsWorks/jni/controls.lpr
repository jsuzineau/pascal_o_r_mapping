...
exports
  ...
  pOnDown name 'Java_com_mars42_jsworks_jsworks_Controls_pOnDown',
  ...
  pOnDoubleClick name 'Java_com_mars42_jsworks_jsworks_Controls_pOnDoubleClick',
  ...
  pAppOnRequestPermissionResult name 'Java_com_mars42_jsworks_jsworks_Controls'
    +'_pAppOnRequestPermissionResult',
  pOnSqliteDataAccessAsyncPostExecute name 'Java_com_mars42_jsworks_jsworks_'
    +'Controls_pOnSqliteDataAccessAsyncPostExecute';
